...
export function Pricing() {
  ...
  return (
    <section id="pricing" ref={ref} className="bg-white px-3 py-6 sm:px-5 sm:py-10 lg:px-10">
      <div className="mx-auto max-w-[1380px] rounded-[20px] bg-[linear-gradient(180deg,#eaf0ff_0%,#f2ffe0_100%)] px-4 py-14 sm:rounded-[32px] sm:px-8 lg:px-10 lg:py-24">
        <SectionHeader
          eyebrow="Harga"
          icon={WalletCards}
